...
# 생각해보자. 거꾸로
# A: 3527  (i=1부터)
# NGE(4): 오른편에 당연히 없으니까 -1
# NGE(3): 오른편에 7밖에 없으니까 7
# NGE(2): 오른쪽에 7, 2니까 2를 먼저 확인 - A[2]보다 작으니까 X, 7을 다음으로 확인 - A[2]보다 크니까 7
# NGE(1): 오른쪽에 7, 2, 5니까 5를 먼저 확인 - A[1]보다 크니까 5  
#      cf. 남은 게 없어 더 이상 확인을 못하면 -1
